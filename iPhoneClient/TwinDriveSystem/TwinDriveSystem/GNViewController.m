...
- (void)viewDidLoad
{
    ...
    navAboutViewController.navigationBar.tintColor = [UIColor clearColor];
    [navAboutViewController.navigationBar setBackgroundImage:[UIImage imageNamed:@"navbar-background.png"] forBarMetrics:UIBarMetricsDefault];
