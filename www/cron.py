...
baned_list = ['皇冠', '聚美秀', '跑车街拍', '汽车街拍', '网友原创街拍', \
              '手机摄影', '头条博客', '精品App推荐', '京东商城', '微电影', \
              '爆笑街拍', 'Camera360', '时尚潮店', '店铺', '彩妆', '包邮', \
              '外贸', '积分', '汽車', '￥', '这里逛', '笑喷', '豪车', '$', \
              '比基尼', '淘到', '运费', '大家快来看', '好评', '挖鼻屎', '帅锅', \
              'zWzfVHE', '这几家可以', '免邮', '装逼', '性价比', '原味店', '商城', '白富美', '淘宝']
